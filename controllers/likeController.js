...
exports.likeItem = async (req, res) => {
  ...
  try {
    ...
    // 判斷是否已點讚
    const hasLiked = checkResult[0].has_liked === 1;
    ...
    if (hasLiked) {
      ...
      newLikesCount -= 1;
      await connection.commit();
      console.log("Action completed: unliked, newLikesCount:", newLikesCount);
      return res.status(200).json({
        message: "取消點讚成功",
        action: "unliked",
        likesCount: newLikesCount,
      ...
      newLikesCount += 1;
      await connection.commit();
      console.log("Action completed: liked, newLikesCount:", newLikesCount);
      return res.status(200).json({
        message: "點讚成功",
        action: "liked",
        likesCount: newLikesCount,
