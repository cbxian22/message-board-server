...
const { broadcastMessage } = require("./controllers/postController"); // 引入 broadcastMessage
// === CORS 設定 ===
app.use(cors()); // 使用 CORS 中間件來處理跨域請求
...
// 設定 WebSocket 實例
app.set("wss", wss); // 把 wss 設定到 app 全域，以便後續在 controller 中引用
